...
describe('Logger Unit Tests', () => {
  ...
  describe('Metadata Logging', () => {
    ...
    it('should handle error objects with stack traces', () => {
      ...
      expect(mockConsole.error).toHaveBeenCalledWith(expect.stringContaining('stack'));
    });
  ...
  describe('Event Logging', () => {
    ...
    it('should log success events', () => {
      ...
      expect(mockConsole.log).toHaveBeenCalledWith(expect.stringContaining('SUCCESS event'));
    });
    ...
    it('should log error events', () => {
      ...
      expect(mockConsole.error).toHaveBeenCalledWith(expect.stringContaining('ERROR event'));
    });
    ...
    it('should log request/response events as debug', () => {
      ...
      expect(mockConsole.debug).toHaveBeenCalledWith(expect.stringContaining('REQUEST event'));
    });
  });
